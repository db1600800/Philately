...
+ (NSString*) createEnvelope: (NSString*) method forNamespace: (NSString*) ns forParameters: (NSString*) params withHeaders: (NSDictionary*) headers
{
    ...
    [s appendString:@"<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:ser=\"http://service.chinapost.com/\" xmlns:wsse=\"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd\" xmlns:wsu=\"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd\" >"];
    ...
    [s appendString:@"<wsse:Security soap:mustUnderstand=\"1\"><wsse:UsernameToken wsu:Id=\"UsernameToken-1\"><wsse:Username>chinapost</wsse:Username>"];
    [s appendString:@"<wsse:Password Type=\"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-username-token-profile-1.0#PasswordText\">chinapostp@ssword</wsse:Password>"];
    [s appendString:@"</wsse:UsernameToken></wsse:Security>"];
...
+ (NSString*) serialize: (id) object {
	if([object respondsToSelector:@selector(serialize)]) {
		return [(SoapObject*)object serialize];
	}

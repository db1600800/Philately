...
//注入table功能
 NSString *CellIdentifier = @"ShoppingCarEmptyTableViewCell";
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
 ...
 ShoppingCarEmptyTableViewCell *cell = (ShoppingCarEmptyTableViewCell*)[self.tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if (!cell)
    {
